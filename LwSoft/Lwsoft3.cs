...
namespace LwSoft
{
    public class Lwsoft3
    {
        ...
        public int BindWindow(int hwnd, DisplayBindKey display, MouseBindKey mouse, KeypadBindKey keypad, int added, int mode)
        {
            object[] args =
            {
        ...
        /// <returns></returns>
        public int CaptureToBuffer(int x1, int y1, int x2, int y2, int flag)
        {
            object[] args =
            {
                x1, y1, x2, y2, flag
        ...
        /// <returns></returns>
        public bool FindPic(int x1, int y1, int x2, int y2, string pic_name,
            ...
            int chickdex = 0, int chickdey = 0, int chickdely = 0)
        {
            object[] args =
            {
                x1, y1, x2, y2, pic_name, delta_color, sim, dir, timeout, ischick, chickdex, chickdey, chickdely
            };
            var result = (int)obj.InvokeMember("FindPic", BindingFlags.InvokeMethod, null, obj_object, args);
            if (result > 0) Console.WriteLine("找到" + pic_name);
            return result > 0;
        }
        ...
        /// <returns></returns>
        public int FindWindow(string title, string @class, string processname,
      ...
      /*  public int GetX()
       ...
       /* public int GetIdx()
        ...
        public Lwsoft3 Delay(int misMin, int misMax)
        {
            object[] args =
            {
                misMin,misMax
        ...
        public Lwsoft3 Delay(int misMin = 500)
        {
            object[] args =
            {
                misMin
